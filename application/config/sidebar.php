<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
  ...
  <li class="nav-item"> <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseDevotee" aria-expanded="true" aria-controls="collapseDevotee"> <i class="far fa-user"></i> <span>Devotee</span> </a>
   ...
   <li class="nav-item"> <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseChola" aria-expanded="true" aria-controls="collapseChola"> <i class="fas fa-calendar-alt"></i> <span>Chola Booking</span> </a>
    <div id="collapseChola" class="collapse" aria-labelledby="headingPages" data-parent="#collapseChola">
      <div class="bg-white py-2 collapse-inner rounded"> <a class="collapse-item" href="<?php echo site_url("master/chola-booking/manage");  ?>">View All</a>
      <a class="collapse-item" href="<?php echo site_url("master/chola-booking/success");  ?>">View Success</a>
       </div>
    </div>
  </li>
 ...
 <!-- <li class="nav-item"> <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseHawanBooking" aria-expanded="true" aria-controls="collapseHawanBooking"> <i class="fas fa-fire"></i> <span>Hawan Booking </span> </a>
    <div id="collapseHawanBooking" class="collapse" aria-labelledby="headingPages" data-parent="#collapseHawanBooking">
      <div class="bg-white py-2 collapse-inner rounded"> <a class="collapse-item" href="<?php //echo site_url("master/hawan-booking/manage");  ?>">View All </a>  </div>
    </div>
  </li>
