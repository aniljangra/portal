...
echo form_hidden('temple_id',$templedata->temple_id);
 ?>
            ...
            <div class="panel-body">
            	<div class="row">
                	<div class="form-group col-md-12 col-sm-12 col-xs-12">
                     <label>Temple <span class="req">*</span> <a href="<?php echo site_url("online-chola-booking/step1"); ?>" style="font-size:12px; text-decoration:underline;">Change Temple</a></label>
    ...
    ?> <?php echo form_error('cb_name'); ?> </div>
               ...
               <div class="form-group col-md-6 col-sm-12 sol-xs-12">
               <label>Mobile Number <span class="note">[OTP will be sent to this number]</span> <span class="req">*</span></label>
               <?php echo form_input(array(
                  'name'  => 'cb_mobile',
                  'type'  => 'text',
                  'placeholder'=>'',
