...
<div class="body">
  ...
  <div role="main" class="main">
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <div class="welcome_heading">Hawan Booking History</div>
        </div>
      </div>
      <div class="row">
        <div class="col-md-12">
            ...
            <table class="table table-bordered table-trans table-striped" id="dataTbDonation" width="100%" cellspacing="0">
              <thead>
                <tr>
                  ...
                  <th width="18%" valign="top" class="column-title">Name</th>
                  <th width="14%" valign="top" class="column-title">Booked  Date</th>
                   <th width="14%" valign="top" class="column-title">Slot</th>
              ...
              <tbody>
                ...
                <tr class="even pointer">
                  ...
                  <td><?php echo $hwrow->hw_orderno; ?></td>
                  <td><?php echo $hwrow->hw_name; ?></td>
                  <td><?php echo date('d-m-Y',strtotime($hwrow->hw_bookfordate)); ?></td>
                   <td><?php echo $hwrow->hw_bookslotname; ?></td>
                  <td>Rs. <?php echo $hwrow->hw_amount; ?>/-</td>
                  <td><?php $hw_transstatus=$hwrow->hw_transstatus; if(empty($hw_transstatus)){ echo "Pending";}else{ echo $hw_transstatus; } ?></td>
                   <td><?php echo date('d-m-Y',strtotime($hwrow->hw_subdatetime)); ?></td>
                  <td width="10%" align="center"><a href="<?php echo site_url("transactions/hawan-booking/$enc_hw_id"); ?>"  title="View" class="view_trans">View </a></td>
                </tr>
                <?php }  ?>
              </tbody>
            </table>
