...
echo form_open_multipart('student/registration-step2/edit',$attributes);
 ?>
    ...
    'type'  => 'text',
    'class' => "form-control",
    'value' =>set_value('reg_twe_yearpassing',$regdata->reg_twe_yearpassing)));
    ...
    'type'  => 'text',
    'class' => "form-control",
    'value' =>set_value('reg_twe_boardname',$regdata->reg_twe_boardname)));
    ...
    'type'  => 'text',
    'class' => "form-control",
    'value' =>set_value('reg_twe_subjects',$regdata->reg_twe_subjects)));
    ...
    'type'  => 'text',
    'class' => "form-control",
    'value' =>set_value('reg_twe_totalmarks',$regdata->reg_twe_totalmarks)));
    ...
    'type'  => 'text',
    'class' => "form-control",
    'value' =>set_value('reg_twe_marksobtained',$regdata->reg_twe_marksobtained)));
    ...
    'type'  => 'text',
    'class' => "form-control",
    'value' =>set_value('reg_twe_percentage',$regdata->reg_twe_percentage)));
    ...
    'type'  => 'text',
    'class' => "form-control",
    'value' =>set_value('reg_mat_yearpassing',$regdata->reg_mat_yearpassing)));
    ...
    'type'  => 'text',
    'class' => "form-control",
    'value' =>set_value('reg_mat_boardname',$regdata->reg_mat_boardname)));
    ...
    'type'  => 'text',
    'class' => "form-control",
    'value' =>set_value('reg_mat_subjects',$regdata->reg_mat_subjects)));
    ...
    'type'  => 'text',
    'class' => "form-control",
    'value' =>set_value('reg_mat_totalmarks',$regdata->reg_mat_totalmarks)));
    ...
    'type'  => 'text',
    'class' => "form-control",
    'value' =>set_value('reg_mat_marksobtained',$regdata->reg_mat_marksobtained)));
    ...
    'type'  => 'text',
    'class' => "form-control",
    'value' =>set_value('reg_mat_percentage',$regdata->reg_mat_percentage)));
