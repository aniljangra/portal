				...
				if($regdata->reg_lastname!=""){  $reg_name.=" ".$regdata->reg_lastname; } echo $reg_name;  ?>
                    ...
                    <tr>
                     ...
                     <tr>
                        ...
                        <td>:</td>
                        <td><strong><?php   if($regdata->reg_id=="2019160175"){
							?>
                            09-07-2019, Time 10:00 AM
                            <?php
							}else{ echo date('d-m-Y',strtotime($regdata->center_date));  ?>, Time 09:00 AM  <?php } ?></strong></td>
                    </tr>
...
<li>This card  is to be preserved by the candidate and shown on demand on the day of aptitude test.</li>
                                ...
                                <li>Candidates are advised to report at <?php   if($regdata->reg_id=="2019160175"){ echo "09:30AM";   }else{ echo "08:30AM"; } ?></li>
							</ol>
                        </td>
                    </tr>
                </table>
