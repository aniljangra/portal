...
echo form_open_multipart("online-chola-booking/verify-otp/$segment3",$attributes);
echo form_hidden('encbid',$segment3);
 ?>			
	...
	'readonly'=>true,
    'class' => "form-control",
    'value' =>set_value('cb_otpmobile',$cholatemp->cb_mobile)));
    ?> 
	...
	'maxlength'=>6,
    'class' => "form-control",
    'value' =>set_value('cb_chola_otp')));
    ?> 
	
	
	
	<?php echo form_error('cb_chola_otp'); ?>
                    </div>
                </div>	
