 ...
 ?>
          <div class="panel panel-info">
            ...
            <div class="panel-body">
              ...
              <div class="row">
              	<div class="col-md-12">
                	<img src="<?php echo base_url(); ?>assets/img/chola_tc.png" style="margin-bottom:20px;" class="img-responsive"/>
                </div>
              </div>
               <div class="row">
              <div class="col-md-12 form-group"><?php echo form_checkbox('cb_accept',1,set_checkbox('cb_accept',1)); ?>  I have read and I agree with the  terms and conditions.</a> <br/>
