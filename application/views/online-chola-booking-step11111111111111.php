...
echo form_open_multipart("online-chola-booking/step2/$segment3",$attributes);
 ...
 ?>
    ...
    'value' =>set_value('cb_temple',$templedata->temple_id)));
    ...
    ?> <?php echo form_error('cb_bookfordate'); ?> </div>
                ...
                <div class="form-group col-md-6 col-sm-12 col-xs-12">
                  ...
                  <label>Name as Per Your Aadhaar Card  <span class="req">*</span></label>
    ...
    ?> <?php echo form_error('cb_name'); ?> </div>
               ...
               <label>ID Proof  <span class="req">*</span></label>
               ...
               <label>Devotee Passport Size Photograph <span class="note">[Less than 500kb]</span></span> <span class="req">*</span></label>
               ...
               <?php echo form_input(array(
                  ...
                  'value' =>set_value('cb_photograph')));

                  ?> <?php echo form_error('cb_photograph'); ?>
...
$count_booked=count($ch_datebooked);
...
if($count_booked>0){
	...
	foreach($ch_datebooked as $cholarow){

			$date_book='"'.$cholarow->cb_bookfordate.'"';
...
$count_inactive=count($ch_inactivedate);

if($count_inactive>0){

	$in_sr=1;

	foreach($ch_inactivedate as $ch_inactiverow){

		$date_book='"'.$ch_inactiverow->dset_date.'"';
...
$count_process=count($ch_processdate);

if($count_process>0){

	$cp_sr=1;

	foreach($ch_processdate as $ch_processrow){

		$date_book='"'.$ch_processrow->cb_bookfordate.'"';
