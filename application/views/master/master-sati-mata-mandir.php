    ...
    <div id="content">
      ...
      <div class="container-fluid">
        <div class="d-sm-flex align-items-center justify-content-between">
          <h1 class="h3 mb-0 text-gray-800 mb-2">Manage Chola Booking All</h1>
        </div>
              ...
              <table class="table table-bordered" id="dataTbChola" width="100%" cellspacing="0">
                <thead>
                  <tr>
                    ...
                    <th width="15%" valign="top" class="column-title">Service Amount</th>
                    <th width="15%" valign="top" class="column-title">Chola Type</th>
				...
				$count=0;
                  ...
                  <tr class="even pointer">
                    ...
                    <td><a href="<?php echo site_url("master/chola-booking/view/$cb_id"); ?>"  title="View" target="_blank"><?php echo $cholarow->cb_orderno; ?></a></td>
                    <td><a href="<?php echo site_url("master/chola-booking/view/$cb_id");  ?>" target="_blank"><?php echo $cholarow->cb_name; ?></a></td>
