      ...
      <div class="container-fluid">
        ...
        <nav aria-label="breadcrumb">
          ...
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="<?php echo site_url("master/donation/manage");  ?>">Manage Donation</a></li>
        ...
        <div class="d-sm-flex align-items-center justify-content-between">
          ...
          <h1 class="h3 mb-0 text-gray-800 mb-2">View Donation</h1>
                    ...
                    <table  style="width:100%" class="table table-bordered">
                      ...
                      <tr>
                       ...
                       <tr>
                        ...
                        <td><?php echo $donationrow->donation_txnrefno;  ?></td>
