      ...
      <div class="container-fluid">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="<?php echo site_url("master/chola-booking/manage");  ?>">Manage Chola Booking</a></li>
            <li class="breadcrumb-item active" aria-current="page">View Chola Booking</li>
          </ol>
        </nav>
        <div class="d-sm-flex align-items-center justify-content-between">
          <h1 class="h3 mb-0 text-gray-800 mb-2">Chola Booking Registration Receipt</h1>
        </div>
        <div class="row">
              ...
              <div class="row">
                <div class="col-md-12">
                  ...
                  <tr>
					  ...
					  if($cb_proof!=""){
					   ?>
                      <img src="<?php echo site_url();?><?php echo $cholarow->cb_proof;  ?>" width="100px">
                      <?php } ?>
                    ...
                    <tr>
                      ...
                      <td class="2"><?php echo $cholarow->cb_aadhar;  ?></td>
                    </tr>
                    <tr>
                      <td><strong>Mobile Number</strong></td>
                      <td colspan="2"><?php echo $cholarow->cb_mobile;  ?></td>
                    </tr>
                    <tr>
                      <td><strong>Address</strong></td>
                      <td colspan="2"><?php echo $cholarow->cb_address;?>,&nbsp;<?php echo $cholarow->cb_city;?>(<?php echo $cholarow->cb_state;?>),&nbsp;<?php echo $cholarow->cb_pincode;  ?></td>
                    </tr>
                    
                    <tr>
                      <td><strong>Service Charge</strong></td>
                      <td colspan="2">Rs. <?php echo $cholarow->cb_amount;  ?>/-</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td colspan="2"><?php echo $cholarow->cb_txnrefno;  ?></td>
                    </tr>
                    <tr>
                      <td><strong>Payment Date</strong></td>
                      <td colspan="2"><?php echo $cholarow->cb_transdate;  ?></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td colspan="2"><?php echo $cholarow->cb_subdatetime;  ?></td>
                    </tr>
                  </table>
