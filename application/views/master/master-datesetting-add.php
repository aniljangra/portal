    ...
    <div id="content">
      ...
      <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between">
          <h1 class="h3 mb-0 text-gray-800 mb-2">Add New Date Setting</h1>
        </div>
        <div class="row">
...
echo form_open_multipart('master/date-setting/add-new',$attributes);
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <select name="dset_hawanbooking" class="form-control">
                        <option value="0"  <?php echo set_select('dset_hawanbooking',0); ?>>On</option>
                        <option value="1"  <?php echo set_select('dset_hawanbooking',1); ?>>Off</option>
                      </select>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <select name="dset_roombooking" class="form-control">
                        <option value="0"  <?php echo set_select('dset_roombooking',0); ?>>On</option>
                        <option value="1"  <?php echo set_select('dset_roombooking',1); ?>>Off</option>
                      </select>
