      ...
      <div class="container-fluid">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="<?php echo site_url("master/chola-datemgmt/manage");  ?>">Manage Chola Date Setting</a></li>
            <li class="breadcrumb-item active" aria-current="page">Add New Date</li>
          </ol>
        </nav>
        <div class="d-sm-flex align-items-center justify-content-between">
          <h1 class="h3 mb-0 text-gray-800 mb-2">Add New Date</h1>
        </div>
        <div class="row">
...
echo form_open_multipart('master/chola-datemgmt/add',$attributes);
              ...
              <div class="col-md-12">
				...
				'readonly'=>true,
				'class' => "form-control",
				'value' =>set_value('dset_templename',$templedata->temple_name)));
				?> <?php echo form_error('dset_templename'); ?> </div>
                  <div class="form-group col-md-6 col-sm-12 col-xs-12">
