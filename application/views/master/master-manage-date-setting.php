    ...
    <div id="content">
      ...
      <div class="container-fluid">
        <div class="d-sm-flex align-items-center justify-content-between">
          <h1 class="h3 mb-0 text-gray-800 mb-2">Manage Date Setting</h1>
        </div>
              ...
              <table class="table table-bordered" id="dataTbDonation" width="100%" cellspacing="0">
                <thead>
                  <tr>
                    ...
                    <th width="32%" valign="top" class="column-title">Date</th>
                    <th width="29%" valign="top" class="column-title">Hawan Booking</th>
                    <th width="23%" valign="top" class="column-title">Room Booking</th>
                    <th width="10%"  align="center" class="column-title no-sort">Edit</th>
                  </tr>
                </thead>
                <tbody>
                  <?php 
                  ...
                  <tr class="even pointer">
                    ...
                    <td><?php echo $datesetrow->dset_date; ?></td>
                    <td><?php if($datesetrow->dset_hawanbooking==1){ echo "Off"; }else{ echo "On"; } ?></td>
                    <td><?php if($datesetrow->dset_roombooking==1){ echo "Off"; }else{ echo "On"; } ?></td>
                    <td width="10%" align="center"><a href="<?php echo site_url("master/date-setting/edit/$dset_id"); ?>"  title="View"><i class="fa fa-edit"></i> </a></td>
                  </tr>
                  <?php }  ?>
                </tbody>
              </table>
