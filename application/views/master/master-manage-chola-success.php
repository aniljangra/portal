    ...
    <div id="content">
      ...
      <div class="container-fluid">
        <div class="d-sm-flex align-items-center justify-content-between">
          <h1 class="h3 mb-0 text-gray-800 mb-2">Manage Chola Booking Success</h1>
        </div>
              ...
              <table class="table table-bordered" id="dataTbChola" width="100%" cellspacing="0">
				...
				$count=0;
                  ...
                  <tr class="even pointer">
                    ...
                    <td><a href="<?php echo site_url("master/user/view/$cb_regid");  ?>" target="_blank"><?php echo $cholarow->cb_name; ?></a></td>
