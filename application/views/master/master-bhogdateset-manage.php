                        ...
                        <table class="table table-bordered" id="dataTbDonation" width="100%" cellspacing="0">
                            ...
                            <thead>
                                ...
                                <tr>
                                    ...
                                    <th width="7%" valign="top" class="column-title">
                                        Sr.
                                    </th>

                                    <th width="67%" valign="top" class="column-title">
                                        Temple
                                    </th>

                                    <th width="17%" valign="top" class="column-title">
                                        Date
                                    </th>

                                    <th width="9%" align="center" class="column-title no-sort">
                                        Action
                                    </th>
                            ...
                            <tbody>
                                ...
                                foreach($datesetdata as $datesetrow){
                                    ...
                                    $enc_dset_id = $this->encryptcode->encrypt(
                                        $dset_id,
                                        ENC_KEY_PASS
                                    );
                                ...
                                <tr class="even pointer">
                                    ...
                                    <td>
                                        <?php echo $datesetrow->temple_name; ?>
                                    </td>
                                    ...
                                    <td>
                                        ...
                                        $dset_date = $datesetrow->dset_date;
                                    ...
                                    <td width="9%" align="center">
                                        ...
                                        <a href="<?php echo site_url("master/bhog-datemgmt/remove/$enc_dset_id"); ?>"
                                           title="Remove"
